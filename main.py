...
def main():
    ...
    response = s.get('https://ssr.res.netease.com/pc/zt/20191112204330/js/index_040f8a7b.js')
    start_subscript = response.text.find('),a=[') + 4
    ...
    for v in data_json:
        ...
        if card_type == '式神':
            if not os.path.exists('./pic/' + card_name):
                os.makedirs('./pic/' + card_name)
